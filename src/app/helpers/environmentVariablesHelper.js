...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'https://mahacyber.ddns.net/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://mahacyber.ddns.net/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://mahacyber.ddns.net/api/config/',
  ...
  PORTAL_API_AUTH_TOKEN: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI3YTc5ZmViMzU1Njk0MGY2ODljNGZlMDhlYjdmMjhkMyJ9.1vJZU4b_GZ72GFdeWNxQ-rgUHKbdkDghIX9OSyjETFw",
  PORTAL_TELEMETRY_PACKET_SIZE: env.sunbird_telemetry_packet_size || 1000,
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'https://mahacyber.ddns.net/api/echo/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://mahacyber.ddns.net/api/',
